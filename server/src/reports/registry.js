...
const REPORT_REGISTRY = {
  ...
  sources: [
    ...
    { id: "profit-loader", label_key: "source_profit_loader", label: "مجمل ربح المبيعات", cat: "profitability", icon: "Percent" },
    { id: "net-profit", label_key: "source_net_profit", label: "صافي الربح", cat: "profitability", icon: "LineChart" },
  ...
  classifications: {
    ...
    sales: [
      ...
      { id: "margin", label_key: "cls_sales_margin", label: "هوامش الربح", detailedQuery: "margin-by-item", summaryQuery: null, availableModes: ["detailed"], supportsDates: true, hasProfit: true, supportsScope: false, dimensions: ["category_id", "item_id"], filters: [], multiSelectFilters: [] },
    ],
    // ── مشتريات (Purchases) ──
    purchases: [
    ...
    employees: [
      ...
      { id: "shifts", label_key: "cls_emp_shifts", label: "الورديات", detailedQuery: "shift-history", summaryQuery: null, availableModes: ["detailed"], supportsDates: true, hasProfit: false, supportsScope: false, dimensions: [], filters: [], multiSelectFilters: [] },
    ...
    treasury: [
      ...
      { id: "reconciliation", label_key: "cls_trs_reconciliation", label: "التسويات", detailedQuery: "cash-consistency", summaryQuery: null, availableModes: ["detailed"], supportsDates: true, hasProfit: false, supportsScope: false, dimensions: [], filters: [], multiSelectFilters: [] },
      { id: "daily-sessions", label_key: "cls_trs_daily_sessions", label: "الجلسات اليومية", detailedQuery: "daily-sessions", summaryQuery: null, availableModes: ["detailed"], supportsDates: true, hasProfit: false, supportsScope: false, dimensions: [], filters: [], multiSelectFilters: [] },
      ...
      { id: "payment-method-flow", label_key: "r45_title", label: "تدفق وسائل الدفع", detailedQuery: "payment-method-flow", summaryQuery: null, availableModes: ["detailed"], supportsDates: true, hasProfit: false, supportsScope: false, dimensions: [], filters: [], multiSelectFilters: [] },
      { id: "reconciliation-exceptions", label_key: "r47_title", label: "استثناءات التسوية", detailedQuery: "reconciliation-exceptions", summaryQuery: null, availableModes: ["detailed"], supportsDates: true, hasProfit: false, supportsScope: false, dimensions: [], filters: [], multiSelectFilters: [] },
    ],
    "payment-flow": [
    ...
    "profit-loader": [
      { id: "by-item", label_key: "cls_profit_by_item", label: "الربح حسب الصنف", detailedQuery: "margin-by-item", summaryQuery: null, availableModes: ["detailed"], supportsDates: true, hasProfit: true, supportsScope: false, dimensions: ["category_id", "item_id"], filters: [], multiSelectFilters: [] },
      { id: "by-category", label_key: "cls_profit_by_category", label: "الربح حسب الفئة", detailedQuery: "margin-by-category", summaryQuery: null, availableModes: ["detailed"], supportsDates: true, hasProfit: true, supportsScope: false, dimensions: ["category_id"], filters: [], multiSelectFilters: [] },
      { id: "health", label_key: "cls_profit_health", label: "صحة الأرباح", detailedQuery: "margin-health", summaryQuery: null, availableModes: ["summary"], supportsDates: false, hasProfit: true, supportsScope: false, dimensions: [], filters: [], multiSelectFilters: [] },
    ...
    "net-profit": [
      { id: "income-statement", label_key: "cls_net_income", label: "قائمة الدخل", detailedQuery: "profit-loss", summaryQuery: null, availableModes: ["summary"], supportsDates: true, hasProfit: false, supportsScope: false, dimensions: [], filters: [], multiSelectFilters: [] },
      { id: "by-category", label_key: "cls_net_by_category", label: "صافي الربح حسب الفئة", detailedQuery: "profit-by-category", summaryQuery: null, availableModes: ["detailed"], supportsDates: true, hasProfit: true, supportsScope: false, dimensions: ["category_id"], filters: [], multiSelectFilters: [] },
      { id: "by-customer", label_key: "cls_net_by_customer", label: "صافي الربح حسب العميل", detailedQuery: "profit-by-customer", summaryQuery: null, availableModes: ["detailed"], supportsDates: true, hasProfit: true, supportsScope: false, dimensions: ["customer_id"], filters: [], multiSelectFilters: [] },
      { id: "by-period", label_key: "cls_net_by_period", label: "صافي الربح حسب الفترة", detailedQuery: "profit-by-period", summaryQuery: null, availableModes: ["detailed"], supportsDates: true, hasProfit: true, supportsScope: false, dimensions: [], filters: [], multiSelectFilters: [] },
      { id: "daily-owner-snapshot", label_key: "cls_net_daily_owner_snapshot", label: "لمحة يومية للمالك", detailedQuery: "daily-owner-snapshot", summaryQuery: null, availableModes: ["summary"], supportsDates: true, hasProfit: true, supportsScope: false, dimensions: [], filters: [], multiSelectFilters: [] },
    ],
    // ── الضرائب (Tax) ──
    tax: [
