    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-base)] p-6" dir="rtl">
      <div className="relative w-full max-w-lg mx-auto">
        ...
        <div className="relative bg-white/95 backdrop-blur-3xl border border-slate-200/60 rounded-[2.5rem] p-12 md:p-16 shadow-[0_20px_60px_-10px_rgba(15,23,42,0.08)] text-center">
          ...
          <Link
            to="/dashboard"
            className="group mt-8 inline-flex items-center gap-3 rounded-2xl bg-primary px-8 py-4 text-[15px] font-black text-white shadow-[0_8px_30px_-8px_rgba(15,23,42,0.4)] transition-all hover:bg-primary-600 hover:shadow-[0_12px_40px_-10px_rgba(15,23,42,0.5)] active:scale-95"
          >
