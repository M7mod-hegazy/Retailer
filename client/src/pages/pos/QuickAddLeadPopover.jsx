...
export default function QuickAddLeadPopover({ open, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 backdrop-blur-sm" onMouseDown={onClose}>
      <div
        dir="rtl"
        className="w-full max-w-sm mx-4 rounded-2xl bg-bg-surface p-5 shadow-2xl animate-fade-in"
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={onClose} className="flex h-7 w-7 items-center justify-center rounded-full text-text-muted hover:bg-bg-overlay">
            <X className="h-4 w-4" />
          </button>
        </div>
        ...
        <div className="space-y-2.5">
          <input
            ...
            className="w-full rounded-lg border border-green-200 bg-green-50/50 px-3 py-2.5 text-sm font-bold text-right outline-none focus:border-green-400 focus:bg-bg-surface placeholder:text-text-muted placeholder:font-normal transition-colors"
          />
          <div className="relative">
            <input
              ...
              className="w-full rounded-lg border border-border-normal bg-bg-overlay px-3 py-2.5 text-sm font-bold outline-none focus:border-indigo-400 focus:bg-bg-surface placeholder:text-text-muted placeholder:font-normal transition-colors pl-8"
            />
          ...
          <input
            ...
            className="w-full rounded-lg border border-border-normal bg-bg-overlay px-3 py-2.5 text-sm font-bold outline-none focus:border-indigo-400 focus:bg-bg-surface placeholder:text-text-muted placeholder:font-normal transition-colors"
          />
          <input
            ref={birthdayRef}
            type="date"
            ...
            className="w-full rounded-lg border border-border-normal bg-bg-overlay px-3 py-2.5 text-sm font-bold text-text-secondary outline-none focus:border-indigo-400 focus:bg-bg-surface transition-colors"
        ...
        <p className="mt-2 text-[10px] font-bold text-text-muted text-center">
