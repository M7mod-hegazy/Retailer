...
export default function PurchaseReturnFormPage() {
  ...
  function resetToIdle() {
    ...
    setStagingCost(""); setListCategoryFilter(null); setListCategoryQuery(""); setPurchasePickerOpen(false); resetActivation();
            ...
            <div data-help="pr-form-refund" className="flex flex-col gap-1.5">
              ...
              <div className="flex gap-1 p-1 rounded-xl bg-slate-100 border border-slate-200/60 shadow-inner">
                {[
                  ...
                  const noSupplierBlocked = opt.requiresSupplier && !supplier;
                  return (
                    <button key={opt.value} onClick={() => !disabled && setSettlementType(opt.value)} disabled={disabled}
                      ...
                      <div className="text-[9px] font-medium leading-tight mt-0.5 hidden sm:block">
                        {noSupplierBlocked ? (
                          <span className="flex items-center justify-center gap-1 text-red-400"><AlertCircle className="h-2.5 w-2.5" />اختر مورداً أولاً</span>
                        ) : opt.desc}
                      </div>
                    </button>
                  );
                  ...
                  <div className="entry-bar">
                    ...
                    <div className="entry-field entry-field--qty">
                      ...
                      <input ref={stagingQtyRef} type="number" data-help="pr-form-qty"
                        ...
                        onFocus={e => e.target.select()} onKeyDown={e => handleKeyDown(e, { nextRef: stagingCostRef, prevRef: itemInputRef })}
