          ...
          <div className="flex flex-col gap-1.5 shrink-0">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                className={`${fieldCls} ${!isToday ? "border-emerald-400 text-emerald-600" : ""} pr-10 pl-10 [&::-webkit-calendar-picker-indicator]:opacity-0 [&::-webkit-calendar-picker-indicator]:absolute [&::-webkit-calendar-picker-indicator]:inset-0 [&::-webkit-calendar-picker-indicator]:cursor-pointer`}
              />
              {isToday && (
              ...
              <div className="p-3 flex flex-col md:flex-row md:items-center gap-2.5">
                ...
                <div className="relative flex-1 w-full min-w-[200px]">
                  ...
                  <input
                    ...
                    className="w-full h-10 rounded-xl bg-slate-50/80 dark:bg-zinc-900/50 border border-transparent pr-10 pl-4 text-2sm font-bold text-zinc-800 dark:text-zinc-250 outline-none hover:bg-slate-100 dark:hover:bg-zinc-900 focus:bg-white dark:focus:bg-zinc-950 focus:border-emerald-450 focus:ring-4 focus:ring-emerald-500/10 transition-all placeholder:text-slate-450 dark:placeholder:text-zinc-550" 
                  />
                </div>
