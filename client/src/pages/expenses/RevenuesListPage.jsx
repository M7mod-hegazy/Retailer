        ...
        <div className="sticky top-6 z-40 mx-auto w-full max-w-4xl">
          ...
          >
            ...
            <div className="px-3 pt-1 pb-2 flex items-center justify-between border-b border-slate-100/50">
              <div className="flex flex-wrap items-center gap-4">
                <div className="flex items-center gap-1.5 cursor-default" title="إجمالي إيرادات اليوم فقط">
                  ...
                  <span className="text-2sm number-fmt-primary text-emerald-600">{fmt(stats.todayAmt)} ج.م</span>
                </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2">
              ...
              <button data-help="add-button" onClick={openCreate} title="تسجيل إيراد جديد (Ctrl+K)" className="h-10 px-6 shrink-0 flex items-center justify-center gap-2 rounded-xl text-2sm font-black text-white bg-primary hover:bg-primary-600 transition-colors shadow-lg shadow-zinc-900/20 active:scale-95 w-full sm:w-auto">
