    ...
    <div className="relative" ref={containerRef}>
      <button 
        ...
        className={`flex items-center gap-2 h-10 px-3 rounded-xl border transition-all outline-none ${
          open 
            ? "bg-bg-surface border-emerald-300 ring-4 ring-emerald-500/10 shadow-sm" 
            ...
            <div className="max-h-[250px] overflow-y-auto no-scrollbar flex flex-col gap-0.5">
              <button
                ...
                className={`w-full text-right px-3 py-2 rounded-xl text-2sm font-bold transition-colors ${
                  value === "" ? "bg-emerald-50 text-emerald-700" : "text-text-secondary hover:bg-bg-overlay"
                }`}
              >
                {placeholder}
              </button>
              {options.map((opt) => (
                <button
                  ...
                  className={`w-full text-right px-3 py-2 rounded-xl text-2sm font-bold transition-colors ${
                    value === opt.value ? "bg-emerald-50 text-emerald-700" : "text-text-secondary hover:bg-bg-overlay"
                  }`}
                >
                  {opt.label}
                </button>
...
function InlineAddForm({ categories, onSubmit, saving, canBackdate, onAddCategoryClick, canAddCategory, lastAddedCategoryId }) {
  ...
  const fieldCls = "h-10 rounded-xl bg-bg-overlay/80 dark:bg-zinc-900/50 hover:bg-bg-overlay/80 dark:hover:bg-zinc-900/80 focus:bg-bg-surface dark:focus:bg-zinc-950 border border-border-normal/60 dark:border-zinc-800/60 focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/10 px-3.5 text-sm font-bold text-text-primary dark:text-zinc-200 outline-none placeholder:text-text-muted dark:placeholder:text-zinc-550 transition-all duration-200";
        ...
        <div className="p-8 flex flex-col gap-6">
          <div className="relative">
            <input 
              ...
              className="w-full bg-transparent text-5xl md:text-7xl number-fmt-primary text-zinc-900 placeholder:text-slate-200 outline-none pb-2 border-b-2 border-border-subtle focus:border-emerald-500 transition-colors"
            />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                <label className="text-[11px] font-black text-text-muted uppercase tracking-widest">تصنيف الإيراد <span className="text-emerald-500">*</span></label>
                {canAddCategory && (
                  <button
                    type="button"
                    onClick={onAddCategoryClick}
              ...
              <select 
                ...
                className="w-full h-12 bg-bg-overlay border border-border-normal rounded-xl px-4 text-sm font-bold outline-none focus:bg-bg-surface focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/10 appearance-none"
              >
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-[11px] font-black text-text-muted uppercase tracking-widest">البيان / المصدر</label>
            <input 
              ref={descRef}
              ...
              className="w-full h-12 bg-bg-overlay border border-border-normal rounded-xl px-4 text-sm font-bold outline-none focus:bg-bg-surface focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/10"
            />
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea 
              ...
              className="w-full h-20 resize-none bg-bg-overlay border border-border-normal rounded-xl px-4 py-3 text-2sm font-medium outline-none focus:bg-bg-surface focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/10"
            />
          </div>
        </div>
              ...
              <div className="px-5 pt-3 pb-2 flex flex-wrap items-center justify-between gap-3 border-b border-[var(--border-subtle)] bg-[var(--bg-surface)]/50">
                <div className="flex flex-wrap items-center gap-4">
                  <div className="flex items-center gap-1.5 cursor-default text-[12px]" title="إجمالي إيرادات اليوم فقط">
                    ...
                    <span className="font-black text-text-muted dark:text-zinc-500 uppercase tracking-wider text-[10px]">إيراد اليوم:</span>
              ...
              <div className="p-3 flex flex-col md:flex-row md:items-center gap-2.5">
                ...
                <div className="relative flex-1 w-full min-w-[200px]">
                  ...
                  <input
                    ...
                    className="w-full h-10 rounded-xl bg-bg-overlay/80 dark:bg-zinc-900/50 border border-transparent pr-10 pl-10 text-2sm font-bold text-zinc-805 dark:text-zinc-250 outline-none hover:bg-bg-overlay dark:hover:bg-zinc-900 focus:bg-bg-surface dark:focus:bg-zinc-950 focus:border-emerald-450 focus:ring-4 focus:ring-emerald-500/10 transition-all placeholder:text-slate-450 dark:placeholder:text-zinc-550" 
                  />
                  {query && (
                          ...
                          <div className="flex items-center gap-1 sm:opacity-0 group-hover:opacity-100 transition-opacity">
                            ...
                            <PermissionGate page="revenues" action="delete">
                              {locked ? (
                                ...
                                <button onClick={(e) => { e.stopPropagation(); handleDelete(row.id); }} title="حذف" className="flex h-9 w-9 items-center justify-center rounded-xl bg-bg-overlay text-text-muted hover:text-emerald-600 hover:bg-emerald-50 transition-all">
