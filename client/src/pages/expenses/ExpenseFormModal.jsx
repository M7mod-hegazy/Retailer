         ...
         <form data-modal-content ref={formRef} onSubmit={handleSubmit} className="p-8">
           <div className="grid grid-cols-2 gap-x-8 gap-y-6">
              ...
              <div className="col-span-1 space-y-1.5">
                 <label className="text-[11px] font-black uppercase text-text-muted tracking-widest">قيمة المصروف</label>
                 <div className="relative">
                    <DollarSign className="absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 text-text-muted" />
                      <input 
                         ...
                         placeholder="0.00"
                          className={`w-full rounded-sm border bg-bg-surface py-2.5 pl-4 pr-10 text-[18px] font-black text-text-primary outline-none transition-all ${errors.amount ? "border-red-400 focus:border-red-500 focus:ring-1 focus:ring-red-500" : "border-border-normal focus:border-rose-600 focus:ring-1 focus:ring-rose-600"}`}
                      />
                  </div>
              ...
              {/* Category */}
              <div className="col-span-1 space-y-1.5">
                 <label className="text-[11px] font-black uppercase text-text-muted tracking-widest">تصنيف المصروف</label>
                 <div className="relative">
              ...
              <div className="col-span-2 space-y-1.5">
                 <label className="text-[11px] font-black uppercase text-text-muted tracking-widest">وصف مختصر</label>
                 <div className="relative">
              ...
              {/* Payment Method */}
              <div className="col-span-1 space-y-1.5">
                 <label className="text-[11px] font-black uppercase text-text-muted tracking-widest">طريقة الدفع</label>
                 <select
              ...
              <div className="col-span-1 space-y-1.5">
                 <label className="text-[11px] font-black uppercase text-text-muted tracking-widest">المصدر المالي</label>
              ...
              {/* Employee */}
              <div className="col-span-1 space-y-1.5">
                 <label className="text-[11px] font-black uppercase text-text-muted tracking-widest">بمعرفة الموظف</label>
                 <div className="relative">
                    <User className="absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 text-text-muted" />
                     <select 
                        ref={employeeRef}
                        value={form.employee_id}
                        onChange={(e) => setForm(f => ({ ...f, employee_id: e.target.value }))}
                        onKeyDown={e => handleKeyDown(e, { nextRef: dateRef, prevRef: sourceRef })}
                        className="w-full appearance-none rounded-sm border border-border-normal py-2 pl-4 pr-10 text-2sm font-bold text-text-primary outline-none"
                     >
              ...
              {/* Date */}
              <div className="col-span-1 space-y-1.5">
                 <label className="text-[11px] font-black uppercase text-text-muted tracking-widest">تاريخ المصروف</label>
                 <div className="relative">
              ...
              {/* Notes */}
              <div className="col-span-2 space-y-1.5">
                 <label className="text-[11px] font-black uppercase text-text-muted tracking-widest">ملاحظات داخلية</label>
                  <textarea 
                     ref={notesRef}
                     value={form.notes}
