...
import {
  ...
  CreditCard, Banknote, HelpCircle, Command, TrendingDown, ArrowLeftRight
} from "lucide-react";
      ...
      <div className="relative z-10 px-8 pt-12 pb-8 max-w-5xl mx-auto w-full">
        <div className="flex flex-col items-center text-center gap-4 mb-10">
          ...
          <motion.p initial={{ y: 10, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.2 }} className="text-sm font-medium text-slate-500 max-w-xl mx-auto leading-relaxed">
            دفتر تشغيلي لإدارة وتسجيل كافة المسحوبات والعهد. استخدم الفلاتر للبحث وتحديد فترات زمنية، واضغط على <kbd className="inline-flex items-center justify-center px-1.5 py-0.5 rounded border border-slate-200 bg-white text-[11px] font-mono text-slate-500 mx-1 shadow-sm">Ctrl+K</kbd> في أي وقت لتسجيل سحب جديد.
          </motion.p>
        </div>
            ...
            <div className="flex flex-col sm:flex-row sm:flex-wrap items-center gap-2 w-full">
              ...
              <div data-help="search-bar" className="relative flex-1 w-full sm:min-w-[150px]">
                ...
                <input
                  ...
                  className="w-full h-10 rounded-xl bg-slate-50/80 border border-transparent pr-9 pl-4 text-2sm font-bold text-zinc-800 outline-none hover:bg-slate-100 focus:bg-white focus:border-amber-300 focus:ring-4 focus:ring-amber-500/10 transition-all placeholder:text-slate-400" 
                />
              </div>
