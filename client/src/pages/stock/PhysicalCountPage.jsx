          ...
          {activeSession?.readOnly ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <PermissionGate page="physical_count" action="edit">
                <button data-help="apply-button" onClick={() => setConfirmDialog(true)} className="px-8 h-14 rounded-full bg-emerald-500 text-slate-950 hover:bg-emerald-400 text-sm font-black uppercase tracking-widest shadow-[0_0_20px_rgba(16,185,129,0.3)] transition-all flex items-center gap-2">
