...
const SYNONYM_GROUPS = [
  ...
  ["مورد", "موردين", "توريد", "مشتريات", "شراء"],
  ["عميل", "عملاء", "زبون", "زباين", "حساب"],
  ["خزنه", "خزينه", "خزنة", "كاش", "نقديه"],
  ["تقرير", "تقارير", "كشف", "ملخص"],
  ["صنف", "اصناف", "منتج", "منتجات", "سلعه", "بضاعه"],
  ["طباعه", "طباعة", "طبع", "اطبع"],
  ["اجل", "دين", "الحساب", "تقسيط", "اقساط"],
  ["جرد", "تسويه", "عد"],
  ["حذف", "إلغاء", "الغاء", "مسح", "شيل"],
  ["اضافة", "اضافه", "تسجيل", "ادخال", "تسجيل"],
  ["شيك", "بنك", "فيزا", "تحصيل", "ايداع"],
  ["تعديل", "تغيير", "تحديث", "تعديل"],
  ["سعر", "تكلفة", "قيمة"],
  ["بحث", "دور", "فتش"],
  ["صلاحية", "انتهاء", "تاريخ", "انتهت"],
  ["عمولة", "رصيد", "مستحق", "مديون", "دائن"],
  ["ورود", "فاتورة", "وردية", "ورديات", "ورد"],
  ["ولاء", "نقاط", "مكافاه", "نقطه", "كافه"],
  ["باركود", "باركورد", "بار", "سكانر", "ماسح"],
  ["اختصار", "كيبورد", "اختصارات", "keyboard", "F4", "F2"],
  ["مرتب", "راتب", "مرتبات", "الحوافز", "بدل", "حوافز"],
  ["بطاقه", "بطاقة", "تاج", "تاغ", "label", "استيكر", "ملصق"],
  ["تسويه", "تسوية", "تطبيق", "تصفيه", "مطابقه"],
  ["محفظه", "محفظة", "فودافون كاش", "تابي", "تمارا", "apple pay"],
  ["صلاحيه", "صلاحية", "انتهاء", "انتهت", "تاريخ", "FIFO", "باتش", "batch"],
  ["سريع", "مبلغ مقطوع", "مقطوع", "قطعي"],
  ["ميزانيه", "ميزانية", "موازنه", "موازنة", "budget"],
  ["سيريال", "رقم تسلسلي", "تسلسلي", "IMEI", "serial"],
  ["صورة", "صوره", "صور", "image", "IMG"],
  ["اعتماد", "اعتماد", "تصديق", "موافقه", "موافقة"],
  ["كشف", "كشف", "statement", "حساب"],
];
...
export function searchHelp(query, opts = {}) {
  ...
  const confident = Boolean(top) && top.score >= 2.0;
