...
export const BLOCK_REGISTRY = {
  ...
  qr:                  { component: QrBlock,                label: "رمز QR",         desc: "رمز استجابة سريعة يحتوي بيانات الفاتورة — يمسحه العميل بكامرة هاتفه لرؤية التفاصيل", group: "foot",     families: ALL },
  ...
  barcode:             { component: BarcodeBlock,           label: "باركود",         desc: "شريط رمزي لرقم الفاتورة — يُمسح بجهاز الباركود للبحث عن الفاتورة سريعاً", group: "foot",     families: ALL },
