          ...
          {!loading && supplier && !editMode && (
            <div className="px-5 py-4 space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[16px] font-black text-slate-900">{supplier.name}</p>
                  {supplier.code && (
                    <span className="text-[11px] font-mono bg-slate-100 text-slate-500 px-2 py-0.5 rounded-md">{supplier.code}</span>
                  )}
                </div>
              </div>
