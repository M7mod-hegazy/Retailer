...
const SUGGESTIONS_BY_PAGE = {
  ...
  "/definitions/items/": ["ازاي اضيف صنف جديد؟", "ازاي اعدل بيانات صنف؟", "ازاي استورد الأصناف من ملف؟"],
  "/accounts/customers/": ["ازاي اشوف تفاصيل العميل؟", "ازاي اعرف رصيد العميل؟", "ازاي اعرف كام للعميل عندي؟"],
  "/accounts/suppliers/": ["ازاي اشوف تفاصيل المورد؟", "ازاي اعرف المستحق للمورد؟", "ازاي اطبع كشف حساب مورد؟"],
