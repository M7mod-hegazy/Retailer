...
export default function FeatureRoute({ featureKey, children }) {
  ...
  return (
    <div className="flex h-full items-center justify-center p-12">
      <div className="flex flex-col items-center gap-4 text-text-muted max-w-xs text-center">
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-bg-overlay">
          <Lock className="h-6 w-6 text-text-muted" />
        </div>
        <div>
          <h2 className="text-base font-black text-text-primary mb-1">الميزة غير مفعّلة</h2>
