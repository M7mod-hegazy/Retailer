...
export default function SearchDropdown({
  ...
  if (!items.length && !showRaw) {
    return (
      <div className="absolute left-0 right-0 z-50 rounded-[12px] border border-border-subtle bg-bg-surface p-4 text-center shadow-[0_10px_40px_-5px_rgba(0,0,0,0.1)]" style={posStyle}>
        {isLoadingMore ? (
  ...
  return (
    <div className="absolute left-0 right-0 z-50 rounded-[12px] border border-border-subtle bg-bg-surface shadow-[0_10px_40px_-5px_rgba(0,0,0,0.1)]" style={posStyle}>
      <div
        ref={listRef}
